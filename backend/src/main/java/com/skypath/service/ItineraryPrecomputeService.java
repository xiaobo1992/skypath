 ...
 */
@Singleton
public class ItineraryPrecomputeService {

    private static final Logger LOG = LoggerFactory.getLogger(ItineraryPrecomputeService.class);
    ...
    public ItineraryPrecomputeService(FlightRepository flightRepository, ItineraryRepository itineraryRepository) {
